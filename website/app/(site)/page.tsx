    ...
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="hero-in relative mx-auto max-w-7xl px-4 pb-40 pt-20 text-white md:pt-32">
          ...
          <div className="mt-8">
            <Link href={s(hero, "cta_href", "/contact-us")} className="btn-white">
      ...
      <section className="mt-[-40px] bg-teal pb-20 pt-36 text-white">
        <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 lg:grid-cols-2">
          <div data-reveal>
            ...
            <div className="mt-8">
              <Link href={s(svc, "cta_href", "/medical-services")} className="btn-white">
      ...
      {s(settings, "map_embed_src") ? (
        <section>
          <h2 className="section-heading heading-accent py-10 text-center" data-reveal>Our Location</h2>
          <div className="relative">
            <iframe
