  ...
  return (
    <>
      ...
      <section className="mx-auto grid max-w-7xl items-center gap-12 px-4 py-20 lg:grid-cols-2">
        <div>
          <h2 className="section-heading">{s(block, "know_heading")}</h2>
      ...
      <section className="bg-teal py-20 text-white">
        <div className="mx-auto max-w-7xl px-4">
          <h2 className="section-heading text-center">{s(block, "mission_heading")}</h2>
          <div className="mt-12 grid gap-8 md:grid-cols-3">
            {list(block, "mission_items").map((item, i) => (
              <div key={i} className="card p-8 text-brand-dark">
      ...
      {testimonials.length > 0 && (
        <section className="bg-brand-light py-20">
          <div className="mx-auto max-w-7xl px-4">
            <h2 className="section-heading text-center">{s(block, "testimonials_heading", "Our Patients' Experiences")}</h2>
            <div className="mt-12 grid gap-6 md:grid-cols-3">
              {testimonials.map((t) => (
                <figure key={t.id} className="card p-8">
